...
* Exercícios de Lógica: Resoluções de desafios em plataformas.

* Projetos Acadêmicos: Trabalhos desenvolvidos durante cursos e graduação.

* Aplicações Reais: CRUDs, integração com bancos de dados e sistemas Spring Boot.

* Explorações de Sintaxe: Testes com novas funcionalidades das versões mais recentes do JDK.
